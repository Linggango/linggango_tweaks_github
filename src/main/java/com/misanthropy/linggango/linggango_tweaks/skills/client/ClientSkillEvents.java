...
import static com.misanthropy.linggango.linggango_tweaks.client.KeyBindings.SKILL_KEY;
    ...
    public static void onClientTick(TickEvent.@NonNull ClientTickEvent event) {
        ...
        while (SKILL_KEY.consumeClick()) {
            ...
            if ("miner".equals(currentClassId)) {
                player.getPersistentData().putBoolean("lt_miner_light_active",
                        !player.getPersistentData().getBoolean("lt_miner_light_active"));
            }
        }
    }
