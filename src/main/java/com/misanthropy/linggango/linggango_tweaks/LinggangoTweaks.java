...
import com.misanthropy.linggango.linggango_tweaks.features.TreeDataManager;
...
import com.misanthropy.linggango.linggango_tweaks.registry.*;
...
public class LinggangoTweaks {
    ...
    public LinggangoTweaks() {
        ...
        MinecraftForge.EVENT_BUS.addListener((AddReloadListenerEvent event) -> event.addListener(new TreeDataManager()));
