...
public class CustomTreeFeature extends Feature<CustomTreeConfiguration> {

    public CustomTreeFeature(Codec<CustomTreeConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(FeaturePlaceContext<CustomTreeConfiguration> context) {
        ...
        TreeDataManager.TreeTemplate treeTemplate = TreeDataManager.getTreeTemplate(structureId);
    ...
    private boolean placeAllBlocks(WorldGenLevel level, BlockPos center, TreeDataManager.TreeTemplate treeTemplate, CustomTreeConfiguration config, RandomSource random, Rotation rotation) {
        boolean placedAnyBlocks = false;
        for (TreeDataManager.BlockInfo blockInfo : treeTemplate.blocks()) {
    ...
    private boolean canPlaceBlock(WorldGenLevel level, BlockPos pos, CustomTreeConfiguration config) {
